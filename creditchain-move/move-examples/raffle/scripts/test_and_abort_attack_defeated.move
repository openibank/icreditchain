script {
    ...
    fun main(attacker: &signer) {
        ...
        let old_balance = coin::balance<creditchain_coin::CreditChainCoin>(attacker_addr);
        ...
        let new_balance = coin::balance<creditchain_coin::CreditChainCoin>(attacker_addr);
