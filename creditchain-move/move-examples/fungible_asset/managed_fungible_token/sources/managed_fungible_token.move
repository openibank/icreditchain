...
module example_addr::managed_fungible_token {
    use creditchain_framework::fungible_asset::Metadata;
    use creditchain_framework::object::{Self, Object};
    use std::string::{utf8, String};
    use std::option;
    use creditchain_token_objects::token::{create_named_token, create_token_seed};
    use creditchain_token_objects::collection::create_fixed_collection;
