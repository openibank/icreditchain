...
- The DAO platform should have a broader coverage of existing popular collections on CreditChain
...
- Relax to globally_unique_**now** from globally_unique_**permanently** as the constraint for **governance token**
    ...
    - we found popular collections (eg CreditChain mingo) are globally_unique_now. We want to make sure our tool work for these collections.
