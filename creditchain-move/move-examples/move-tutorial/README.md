---
title: "CreditChain Move Tutorial"
slug: "move-tutorial"
---
...
If you want to use an IDE for working through the examples, we recommend CLion/IntelliJ, which has good support for CreditChain Move.
