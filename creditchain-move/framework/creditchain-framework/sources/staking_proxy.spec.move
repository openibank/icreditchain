spec creditchain_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/ibankio/creditchain/blob/main/libra2-move/framework/libra2-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        use creditchain_std::simple_map;
        use creditchain_framework::staking_contract::{Store};
