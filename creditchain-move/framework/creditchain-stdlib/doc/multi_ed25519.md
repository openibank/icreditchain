...
The identifier of the MultiEd25519 signature scheme, which is used when deriving CreditChain authentication keys by hashing
...
Derives the CreditChain-specific authentication key of the given Ed25519 public key.
