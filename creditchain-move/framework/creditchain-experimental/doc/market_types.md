...
<dt>
<code>maker_cancellation_reason: <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>taker_cancellation_reason: <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>get_order_metadata_bytes: |M|<a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt; <b>has</b> <b>copy</b> + drop</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="market_types.md#0x7_market_types_new_settle_trade_result">new_settle_trade_result</a>(settled_size: u64, maker_cancellation_reason: <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a>&gt;, taker_cancellation_reason: <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a>&gt;): <a href="market_types.md#0x7_market_types_SettleTradeResult">market_types::SettleTradeResult</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="market_types.md#0x7_market_types_new_market_clearinghouse_callbacks">new_market_clearinghouse_callbacks</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    // validate_settlement_update_f arguments: <a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_taker, is_long, price, size
    validate_order_placement_f: |<b>address</b>, OrderIdType, bool, bool, u64,  TimeInForce, u64, M| bool <b>has</b> drop + <b>copy</b>,
    // place_maker_order_f arguments: <a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, price, size, order_metadata
    place_maker_order_f: |<b>address</b>, OrderIdType, bool, u64, u64, M| <b>has</b> drop + <b>copy</b>,
    // cleanup_order_f arguments: <a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, remaining_size
    cleanup_order_f: |<b>address</b>, OrderIdType, bool, u64| <b>has</b> drop + <b>copy</b>,
    /// decrease_order_size_f arguments: <a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, price, size
    decrease_order_size_f: |<b>address</b>, OrderIdType, bool, u64, u64| <b>has</b> drop + <b>copy</b>,
    /// get a <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/string.md#0x1_string">string</a> representation of order metadata <b>to</b> be used in events
    get_order_metadata_bytes: |M| <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt; <b>has</b> drop + <b>copy</b>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="market_types.md#0x7_market_types_validate_order_placement">validate_order_placement</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    (self.validate_order_placement_f)(<a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_taker, is_bid, price, time_in_force, size, order_metadata)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="market_types.md#0x7_market_types_place_maker_order">place_maker_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    size: u64,
    order_metadata: M) {
    (self.place_maker_order_f)(<a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, price, size, order_metadata)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="market_types.md#0x7_market_types_cleanup_order">cleanup_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    is_bid: bool,
    remaining_size: u64) {
    (self.cleanup_order_f)(<a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, remaining_size)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="market_types.md#0x7_market_types_decrease_order_size">decrease_order_size</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    price: u64,
    size: u64,) {
    (self.decrease_order_size_f)(<a href="../../creditchain-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, price, size)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="market_types.md#0x7_market_types_get_order_metadata_bytes">get_order_metadata_bytes</a>&lt;M: store + <b>copy</b> + drop&gt;(
    self: &<a href="market_types.md#0x7_market_types_MarketClearinghouseCallbacks">MarketClearinghouseCallbacks</a>&lt;M&gt;,
    order_metadata: M): <a href="../../creditchain-framework/../creditchain-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
