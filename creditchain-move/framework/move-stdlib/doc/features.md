...
Defines feature flags for CreditChain. Those are used in CreditChain specific implementations of features in
the Move stdlib, the CreditChain stdlib, and the CreditChain framework.
...
-  [Function `get_creditchain_stdlib_chain_id_feature`](#0x1_features_get_creditchain_stdlib_chain_id_feature)
-  [Function `creditchain_stdlib_chain_id_enabled`](#0x1_features_creditchain_stdlib_chain_id_enabled)
...
<a id="0x1_features_CREDITCHAIN_STD_CHAIN_ID_NATIVES"></a>

Whether the new <code>creditchain_stdlib::type_info::chain_id()</code> native for fetching the chain ID is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_CREDITCHAIN_STD_CHAIN_ID_NATIVES">CREDITCHAIN_STD_CHAIN_ID_NATIVES</a>: u64 = 4;
</code></pre>



<a id="0x1_features_CREDITCHAIN_UNIQUE_IDENTIFIERS"></a>

Whether enable MOVE functions to call create_auid method to create AUIDs.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_CREDITCHAIN_UNIQUE_IDENTIFIERS">CREDITCHAIN_UNIQUE_IDENTIFIERS</a>: u64 = 23;
</code></pre>
...
Deprecated by <code>creditchain_framework::jwk_consensus_config::JWKConsensusConfig</code>.
...
Whether creditchain_framwork enables the behavior of module event migration.
...
Whether the new <code>creditchain_stdlib::multi_ed25519::public_key_validate_internal_v2()</code> native is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient
...
<a id="0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE"></a>

Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE</a>: u64 = 64;
</code></pre>
...
<a id="0x1_features_OPERATIONS_DEFAULT_TO_FA_LBT_STORE"></a>

Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_OPERATIONS_DEFAULT_TO_FA_LBT_STORE">OPERATIONS_DEFAULT_TO_FA_LBT_STORE</a>: u64 = 65;
</code></pre>
...
Whether enable paritial governance voting on creditchain_governance.
Lifetime: transient
...
<a id="0x1_features_PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS"></a>



<pre><code><b>const</b> <a href="features.md#0x1_features_PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS">PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS</a>: u64 = 61;
</code></pre>
...
Deprecated by <code>creditchain_framework::randomness_config::RandomnessConfig</code>.
...
<a id="0x1_features_get_creditchain_stdlib_chain_id_feature"></a>

## Function `get_creditchain_stdlib_chain_id_feature`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_creditchain_stdlib_chain_id_feature">get_creditchain_stdlib_chain_id_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_creditchain_stdlib_chain_id_feature">get_creditchain_stdlib_chain_id_feature</a>(): u64 { <a href="features.md#0x1_features_CREDITCHAIN_STD_CHAIN_ID_NATIVES">CREDITCHAIN_STD_CHAIN_ID_NATIVES</a> }
</code></pre>
...
<a id="0x1_features_creditchain_stdlib_chain_id_enabled"></a>

## Function `creditchain_stdlib_chain_id_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_creditchain_stdlib_chain_id_enabled">creditchain_stdlib_chain_id_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_creditchain_stdlib_chain_id_enabled">creditchain_stdlib_chain_id_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_CREDITCHAIN_STD_CHAIN_ID_NATIVES">CREDITCHAIN_STD_CHAIN_ID_NATIVES</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_primary_apt_fungible_store_at_user_address_enabled">primary_apt_fungible_store_at_user_address_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS">PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_new_accounts_default_to_fa_apt_store_feature">get_new_accounts_default_to_fa_apt_store_feature</a>(): u64 { <a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_new_accounts_default_to_fa_apt_store_enabled">new_accounts_default_to_fa_apt_store_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_operations_default_to_fa_apt_store_feature">get_operations_default_to_fa_apt_store_feature</a>(): u64 { <a href="features.md#0x1_features_OPERATIONS_DEFAULT_TO_FA_LBT_STORE">OPERATIONS_DEFAULT_TO_FA_LBT_STORE</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_operations_default_to_fa_apt_store_enabled">operations_default_to_fa_apt_store_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_OPERATIONS_DEFAULT_TO_FA_LBT_STORE">OPERATIONS_DEFAULT_TO_FA_LBT_STORE</a>)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="features.md#0x1_features_spec_new_accounts_default_to_fa_apt_store_enabled">spec_new_accounts_default_to_fa_apt_store_enabled</a>(): bool {
   <a href="features.md#0x1_features_spec_is_enabled">spec_is_enabled</a>(<a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE</a>)
}
</code></pre>
