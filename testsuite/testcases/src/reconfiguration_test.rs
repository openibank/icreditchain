...
impl NetworkTest for ReconfigurationTest {
    ...
    //     let mut creditchain_root_account = ctx.swarm().chain_info().root_account;
    //     let allowed_nonce = 0;
    ...
    //             let remove_txn = creditchain_root_account.sign_with_transaction_builder(
    ...
    //                 full_node_client,
    //                 &mut creditchain_root_account,
    //                 vec![remove_txn],
    //             )
    //             .await
    //             .unwrap();
    //             expect_epoch(full_node_client, 2).await.unwrap();
    //             let add_txn = creditchain_root_account.sign_with_transaction_builder(
    ...
    //             for i in 1..count / 2 {
    //                 let upgrade_txn = creditchain_root_account.sign_with_transaction_builder(
    //                     tx_factory.update_creditchain_consensus_config(
    //                         allowed_nonce,
    ...
    //                 let downgrade_txn = creditchain_root_account.sign_with_transaction_builder(
    //                     tx_factory.update_creditchain_consensus_config(
    //                         allowed_nonce,
    ...
    //             let update_txn = creditchain_root_account.sign_with_transaction_builder(
    //                 tx_factory.update_creditchain_version(allowed_nonce, magic_number),
    //             );
    //             execute_and_wait_transactions(
    //                 full_node_client,
    //                 &mut creditchain_root_account,
