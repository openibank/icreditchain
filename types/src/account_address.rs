...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"creditchain_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"creditchain_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"creditchain_framework::vesting";
...
// See this issue for potential improvements: https://github.com/ibankio/creditchain/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, creditchain_crypto_derive::CryptoHasher)]
