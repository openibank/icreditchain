...
from cases.init import test_creditchain_header_included, test_init, test_metrics_accessible
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="What branch the CreditChain CLI used for the localnet should be built from",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--working-directory",
        default="/tmp/creditchain-cli-tests",
...
async def run_tests(run_helper):
    ...
    # Make sure the creditchain-cli header is included on the original request
    test_creditchain_header_included(run_helper)
