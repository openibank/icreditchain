...
| genesis.username_prefix | string | `"creditchain-node"` | Validator username prefix, used to get genesis secrets. This should be the fullname for the creditchain-node helm release |
