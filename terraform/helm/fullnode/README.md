...
This Helm chart deploys a public fullnode for the CreditChain blockchain network. The
fullnode connects to CreditChain validators and synchronises the blockchain state to
